...
// -tags hugot. The YOLOS signature model runs via yalue/onnxruntime_go
...
func LoadSignatureDetector(_ string) (VisualDetector, error) {
	return nil, fmt.Errorf("signature model requires `go build -tags hugot` and libonnxruntime")
}
