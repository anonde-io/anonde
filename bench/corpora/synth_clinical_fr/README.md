# bench/corpora/synth_clinical_fr — French slice of the synthetic clinical bench
...
```bash
make -C bench/corpora/synth_clinical_fr all
open bench/corpora/synth_clinical_fr/REPORT.md
```
