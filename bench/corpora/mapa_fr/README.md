# bench/corpora/mapa_fr — French legal/administrative PII bench (MAPA)
...
language slice differs. The loader is shared:
    ...
    ../mapa_en/cmd/fetch_mapa.py --language fr

## What it does

- Runs anonde + Presidio over the French MAPA slice.
...
make -C bench/corpora/mapa_fr data

# Run anonde (patterns + GLiNER is the production stack).
make -C bench/corpora/mapa_fr anonde ANONDE_BACKEND=gliner

# Run Presidio (needs the French spaCy model).
python -m spacy download fr_core_news_lg
make -C bench/corpora/mapa_fr presidio

# Compare.
make -C bench/corpora/mapa_fr report
```
