# bench/corpora/synth_finance_fr — French slice of the synthetic financial bench
...
```bash
make -C bench/corpora/synth_finance_fr all
open bench/corpora/synth_finance_fr/REPORT.md
```
