# bench/corpora/synth_finance_it — Italian slice of the synthetic financial bench
...
```bash
make -C bench/corpora/synth_finance_it all
open bench/corpora/synth_finance_it/REPORT.md
```
