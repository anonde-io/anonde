# bench/corpora/synth_clinical_it — Italian slice of the synthetic clinical bench
...
```bash
make -C bench/corpora/synth_clinical_it all
open bench/corpora/synth_clinical_it/REPORT.md
```
