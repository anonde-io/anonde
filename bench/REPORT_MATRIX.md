...
|---|---:|---:|---:|---:|
| **English** | **9.8%** 🥇 | 36.5% | 39.8% | 19.4% |
| **German** | **6.4%** 🥇 | 38.3% | 31.9% | 28.7% |
...
| _Σ Retail finance_ | _all langs_ | **8.2%** 🥇 | 24.4% | 21.3% | 23.5% | 18.9% | ✅ |
| _Σ Enterprise logs_ | _all langs_ | **13.2%** 🥇 | 28.9% | 31.5% | 73.2% | 15.3% | ✅ |
...
| | | | | | | | |
| _Σ all domains_ | _English_ | **9.8%** 🥇 | 35.6% | 36.5% | 39.8% | 19.4% | ✅ |
| _Σ all domains_ | _German_ | **6.4%** 🥇 | 25.0% | 38.3% | 31.9% | 28.7% | ✅ |
...
|---|---|---:|---:|---:|---:|---:|
| **Σ ALL** | **all** | **67.1% (31918 fp)** | **76.9% (12284 fp)** | **58.2% (26875 fp)** | **79.2% (12753 fp)** 🥇 | **75.2% (4692 fp)** |
| | | | | | | |
| _Σ Clinical / medical de-identification_ | _all langs_ | 60.9% (8527 fp) | 72.0% (3197 fp) | 53.2% (8508 fp) | **88.5% (1491 fp)** 🥇 | 88.4% (737 fp) |
| _Σ Legal / administrative_ | _all langs_ | 43.2% (4153 fp) | **81.4% (587 fp)** 🥇 | 47.4% (2242 fp) | 45.5% (3315 fp) | 75.9% (228 fp) |
| _Σ Retail finance_ | _all langs_ | 83.2% (2275 fp) | 84.9% (1649 fp) | 79.4% (2391 fp) | **92.0% (957 fp)** 🥇 | 83.5% (878 fp) |
| _Σ Enterprise logs_ | _all langs_ | 73.2% (1034 fp) | **83.7% (502 fp)** 🥇 | 57.3% (1554 fp) | 75.9% (243 fp) | 30.2% (2497 fp) |
| _Σ General structured PII_ | _all langs_ | 67.8% (13373 fp) | 71.0% (5199 fp) | 54.5% (8863 fp) | 78.3% (5131 fp) | **93.1% (113 fp)** 🥇 |
| _Σ Academic NER (newswire / social)_ | _all langs_ | 38.6% (1479 fp) | 41.3% (334 fp) | **71.5% (378 fp)** 🥇 | 57.9% (829 fp) | 70.0% (36 fp) |
| _Σ Adversarial / out-of-distribution_ | _all langs_ | 83.3% (1077 fp) | **86.5% (816 fp)** 🥇 | 49.7% (2939 fp) | 80.0% (787 fp) | 80.4% (203 fp) |
| | | | | | | |
| _Σ all domains_ | _English_ | 56.5% (9566 fp) | 57.2% (6800 fp) | 65.2% (4281 fp) | **79.4% (2240 fp)** 🥇 | 53.5% (2693 fp) |
| _Σ all domains_ | _German_ | 69.0% (10119 fp) | 79.9% (4620 fp) | 58.9% (9000 fp) | 79.3% (4336 fp) | **85.7% (935 fp)** 🥇 |
...
|---|---|---:|---:|---:|---:|---:|:--:|
| **Clinical / medical de-identification** | English | **1.6%** 🥇 | 8.0% | 20.3% | 23.3% | 24.4% | ✅ |
...
| **Retail finance** | German | **2.6%** 🥇 | 3.4% | 24.1% | 22.6% | 21.1% | ✅ |
...
| **Enterprise logs** | English | **13.2%** 🥇 | 28.9% | 31.5% | 73.2% | 15.3% | ✅ |
...
|---|---|---:|---:|---:|---:|---:|
| **Clinical / medical de-identification** | English | 51.9% (2035 fp) | 51.2% (1929 fp) | 78.3% (458 fp) | 93.9% (126 fp) | **99.2% (8 fp)** 🥇 |
| **Clinical / medical de-identification** | German | 53.2% (2905 fp) | 74.2% (1158 fp) | 44.6% (2796 fp) | **87.7% (334 fp)** 🥇 | 87.4% (275 fp) |
...
| **Retail finance** | German | 80.2% (1121 fp) | 85.1% (785 fp) | 78.9% (891 fp) | **90.0% (460 fp)** 🥇 | 88.6% (239 fp) |
...
| **Enterprise logs** | English | 73.2% (1034 fp) | **83.7% (502 fp)** 🥇 | 57.3% (1554 fp) | 75.9% (243 fp) | 30.2% (2497 fp) |
| **General structured PII** | English | 53.8% (4271 fp) | 46.6% (3359 fp) | 67.8% (970 fp) | 83.4% (696 fp) | **92.3% (30 fp)** 🥇 |
| **General structured PII** | German | 68.5% (2845 fp) | 71.6% (1119 fp) | 61.4% (1362 fp) | 77.8% (1168 fp) | **94.6% (14 fp)** 🥇 |
...
| **Academic NER (newswire / social)** | English | 40.5% (652 fp) | 19.1% (110 fp) | **67.2% (208 fp)** 🥇 | 56.6% (377 fp) | 63.8% (21 fp) |
| **Academic NER (newswire / social)** | German | 37.0% (827 fp) | 48.3% (224 fp) | 75.4% (170 fp) | 58.9% (452 fp) | **75.8% (15 fp)** 🥇 |
| **Adversarial / out-of-distribution** | German | 83.3% (1077 fp) | **86.5% (816 fp)** 🥇 | 49.7% (2939 fp) | 80.0% (787 fp) | 80.4% (203 fp) |
...
|---|---:|---:|---:|---:|---:|
| `synth_clinical_en` | 8.0% | **1.6%** 🥇 | 20.3% | 23.3% | 24.4% |
...
| Corpus | `anonde-patterns` | `anonde-ner` | `presidio` | `gliner-py` | `openai-pf` |
|---|---:|---:|---:|---:|---:|
| `synth_clinical_en` | 5.3% | **1.7%** 🥇 | 26.7% | 26.4% | 17.3% |
...
| Corpus | `anonde-patterns` | `anonde-ner` | `presidio` | `gliner-py` | `openai-pf` |
|---|---:|---:|---:|---:|---:|
| `finance_de` | 3.2% | **1.6%** 🥇 | 25.9% | 26.2% | 20.5% |
...
| Corpus | `anonde-patterns` | `anonde-ner` | `presidio` | `gliner-py` | `openai-pf` |
|---|---:|---:|---:|---:|---:|
| `finance_de` | 3.3% | **1.7%** 🥇 | 30.2% | 29.2% | 16.7% |
...
| Corpus | `anonde-patterns` | `anonde-ner` | `presidio` | `gliner-py` | `openai-pf` |
|---|---:|---:|---:|---:|---:|
| `synth_logs` | 28.9% | **13.2%** 🥇 | 31.5% | 73.2% | 15.3% |
...
| Corpus | `anonde-patterns` | `anonde-ner` | `presidio` | `gliner-py` | `openai-pf` |
|---|---:|---:|---:|---:|---:|
| `synth_logs` | 34.7% | 16.4% | 39.6% | 79.7% | **7.7%** 🥇 |
...
|---|---:|---:|---:|---:|---:|
| `synth_clinical_en` | 3 ms / 5 ms | 358 ms / 569 ms | 33 ms / 47 ms | 351 ms / 450 ms | 772 ms / 868 ms |
| `openmed` | 9 ms / 28 ms | 1.3 s / 4.4 s | 125 ms / 326 ms | 1.9 s / 9.1 s | 7.7 s / 22.0 s |
| `synth_clinical` | 3 ms / 4 ms | 440 ms / 701 ms | 46 ms / 59 ms | 590 ms / 774 ms | 1.6 s / 2.3 s |
| `pharmaconer_es` | 4 ms / 8 ms | 1.0 s / 2.3 s | 66 ms / 153 ms | 1.2 s / 3.4 s | 4.1 s / 8.9 s |
| `meddocan_es` | 5 ms / 9 ms | 1.3 s / 2.4 s | 88 ms / 168 ms | 1.5 s / 3.4 s | 4.9 s / 8.0 s |
| `synth_clinical_fr` | 2 ms / 3 ms | 608 ms / 801 ms | 50 ms / 70 ms | 638 ms / 896 ms | 1.8 s / 2.5 s |
| `synth_clinical_it` | 2 ms / 3 ms | 491 ms / 865 ms | 48 ms / 66 ms | 720 ms / 994 ms | 1.9 s / 2.6 s |
| `mapa_en` | 1 ms / 2 ms | 113 ms / 293 ms | 10 ms / 29 ms | 194 ms / 361 ms | 309 ms / 946 ms |
| `legal_de` | 3 ms / 3 ms | 373 ms / 474 ms | 36 ms / 52 ms | 464 ms / 574 ms | 1.2 s / 1.6 s |
| `mapa_de` | 1 ms / 2 ms | 115 ms / 223 ms | 9 ms / 18 ms | 196 ms / 298 ms | 330 ms / 607 ms |
| `mapa_es` | 0 ms / 2 ms | 127 ms / 317 ms | 10 ms / 27 ms | 208 ms / 401 ms | 348 ms / 803 ms |
| `mapa_fr` | 0 ms / 1 ms | 136 ms / 283 ms | 11 ms / 29 ms | 230 ms / 388 ms | 345 ms / 704 ms |
| `mapa_it` | 0 ms / 1 ms | 122 ms / 235 ms | 10 ms / 18 ms | 203 ms / 307 ms | 366 ms / 653 ms |
| `synth_finance_en` | 2 ms / 3 ms | 297 ms / 487 ms | 33 ms / 59 ms | 373 ms / 585 ms | 787 ms / 992 ms |
| `finance_de` | 2 ms / 3 ms | 388 ms / 537 ms | 31 ms / 49 ms | 440 ms / 628 ms | 635 ms / 729 ms |
| `synth_finance_de` | 2 ms / 3 ms | 322 ms / 480 ms | 30 ms / 59 ms | 393 ms / 614 ms | 876 ms / 1.2 s |
| `synth_finance_es` | 1 ms / 2 ms | 338 ms / 490 ms | 29 ms / 53 ms | 416 ms / 650 ms | 855 ms / 1.2 s |
| `synth_finance_fr` | 1 ms / 2 ms | 351 ms / 500 ms | 34 ms / 63 ms | 432 ms / 647 ms | 1.0 s / 1.3 s |
| `synth_finance_it` | 1 ms / 2 ms | 363 ms / 522 ms | 31 ms / 56 ms | 429 ms / 645 ms | 944 ms / 1.2 s |
| `synth_logs` | 4 ms / 9 ms | 732 ms / 1.5 s | 62 ms / 154 ms | 1.2 s / 3.1 s | 7.8 s / 11.1 s |
| `ai4privacy_en` | 1 ms / 2 ms | 221 ms / 332 ms | 23 ms / 32 ms | 313 ms / 429 ms | 643 ms / 862 ms |
| `ai4privacy_de` | 1 ms / 2 ms | 234 ms / 337 ms | 20 ms / 28 ms | 319 ms / 425 ms | 666 ms / 875 ms |
| `ai4privacy_es` | 1 ms / 1 ms | 253 ms / 367 ms | 20 ms / 27 ms | 363 ms / 489 ms | 638 ms / 743 ms |
| `ai4privacy_fr` | 1 ms / 1 ms | 239 ms / 327 ms | 26 ms / 36 ms | 326 ms / 420 ms | 630 ms / 827 ms |
| `ai4privacy_it` | 1 ms / 1 ms | 236 ms / 340 ms | 20 ms / 28 ms | 322 ms / 433 ms | 722 ms / 939 ms |
| `conll2003_en` | 0 ms / 1 ms | 72 ms / 129 ms | 7 ms / 13 ms | 165 ms / 222 ms | 155 ms / 312 ms |
| `wnut_17` | 0 ms / 1 ms | 58 ms / 107 ms | 5 ms / 9 ms | 106 ms / 145 ms | 208 ms / 299 ms |
| `wikiann_de` | 0 ms / 1 ms | 65 ms / 105 ms | 5 ms / 9 ms | 150 ms / 185 ms | 124 ms / 296 ms |
| `germeval_14` | 0 ms / 1 ms | 85 ms / 131 ms | 7 ms / 11 ms | 169 ms / 211 ms | 210 ms / 343 ms |
| `adversarial_de` | 3 ms / 4 ms | 458 ms / 698 ms | 43 ms / 57 ms | 652 ms / 1.1 s | 3.0 s / 4.1 s |
